...
/**
 * <b>VisualizeGraph</b><p>
 * 
 * @author Inês Justo (84804), Luis Pedro Moura (83808), Maria João Lavoura (84681), Pedro Teixeira (84715)
 * @version May-June 2018
 * @see https://stackoverflow.com/questions/37740057/jung-large-graph-visualization
 */
public class VisualizeGraph {
	...
	private static void createAndShowGUI()
	{
		...
		VisualizationViewer<String, String> vv = new VisualizationViewer<String, String>(new FRLayout<String, String>(g, size));
